...
% NOTE: The word count is not accurate on the lipsum 
% generated text but works fine on "real" text :)
...
<<wordcount,echo=FALSE,message=FALSE>>=
system("./texcount.pl -total ./DraftTemplate_wc.tex > wordcount.txt")
@
